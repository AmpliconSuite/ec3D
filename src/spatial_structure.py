...
def max_poisson_likelihood(C, N, ini_x, ini_C1, idx_nodup, idx_dup, dup_times, idx_map, round = 5000, alpha = -3.0, beta = 1.0, reg = 0.05, maxiter = 10000, start_time_ = None, gt_structure = None):
	"""
